async function i24News(){
    let getData = fetch("https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=20&playlistId=PLxnSgwbAmIteZuwUiyg2yB8Jo8G56HvRd&key=AIzaSyA6aG6XTAj5ktnvySRT_2nwTna45arwZ2s")
...
async function display24() {
    let getRyan = await i24News()
    // console.log(getRyan)
