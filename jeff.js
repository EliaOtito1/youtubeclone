async function jeffT(){
    let getData = fetch("https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=500&playlistId=PLX3ZpnAq5SLtS4KJMSskoMOgwwwDr8LGV&key=AIzaSyA6aG6XTAj5ktnvySRT_2nwTna45arwZ2s")
...
async function jeffDisplay() {
    let getRyan = await jeffT()
    // console.log(getRyan)
...
//clearing the suggestion box /div on when we click on the body
