async function theDuran(){
    let getData = fetch("https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=600&playlistId=PL3Ra9O20XOxJcZXzml7vbFPt3MHvnAFDj&key=AIzaSyA6aG6XTAj5ktnvySRT_2nwTna45arwZ2s")
...
async function displayDuran() {
    let getRyan = await theDuran()
    // console.log(getRyan)
