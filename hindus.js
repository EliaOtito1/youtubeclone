async function hinduNews(){
    let getData = fetch("https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PL9wl9ZX1TMB6z0Kk7YOFZs0NYL4jvcyFx&key=AIzaSyA6aG6XTAj5ktnvySRT_2nwTna45arwZ2s")
...
async function hindiLive() {
    let getRyan = await hinduNews()
    // console.log(getRyan)
...
// implementing search video based opn the API Fetch
let search = document.querySelector("#search")
search.addEventListener('keyup',async function(e) {
    let searchValue = e.target.value.toUpperCase()
    let getData = await hinduNews()
