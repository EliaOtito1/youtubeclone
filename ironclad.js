async function ironClad(){
    let getData = fetch("https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=500&playlistId=PLeDdum80k5ENvEv2khGE2X7tGRfC40C-Q&key=AIzaSyA6aG6XTAj5ktnvySRT_2nwTna45arwZ2s")
...
async function ironCladShow() {
    let getRyan = await ironClad()
    // console.log(getRyan)
...
// clearing the dyanmic search when, when click on the body
